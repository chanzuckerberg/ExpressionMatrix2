...
e.addCells('ExpressionMatrix1.csv', ',', 'MetaData1.csv', ',', maxTermCountForApproximateSimilarityComputation)
e.addCells('ExpressionMatrix2.csv', ',', 'MetaData2.csv', ',', maxTermCountForApproximateSimilarityComputation)
