...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description="Creates data files for Expression Matrix 2 from csv data.")
	...
	parser.add_argument('--similar-pairs-highinfo', dest='similarpairshighinfo', action='store', default='LshHighInfo', help='Name for similar pairs for high info genes')
