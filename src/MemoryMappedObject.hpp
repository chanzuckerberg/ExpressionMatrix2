...
#ifndef CZI_EXPRESSION_MATRIX2_MEMORY_MAPPED_OBJECT_HPP
#define CZI_EXPRESSION_MATRIX2_MEMORY_MAPPED_OBJECT_HPP
...
template<class T> class ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object {
public:
...
// Default constructor.
template<class T> inline ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::Object() :
    header(0),
    data(0),
    isOpen(false),
...
// and with write access.
// Return the file descriptor.
template<class T> inline int ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::openNew(const string& name)
{
...
// Open the given existing file.
// Return the file descriptor.
template<class T> inline int ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::openExisting(const string& name, bool readWriteAccess)
{
    const int fileDescriptor = ::open(
        name.c_str(),
...
// Truncate the given file descriptor to the specified size.
template<class T> inline void ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::truncate(int fileDescriptor, size_t fileSize)
{
...
// Map to memory the given file descriptor for the specified size.
template<class T> inline void* ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::map(int fileDescriptor, size_t fileSize, bool writeAccess)
{
...
// Find the size of the file corresponding to an open file descriptor.
template<class T> inline size_t ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::getFileSize(int fileDescriptor)
{
...
template<class T> inline void ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::createNew(const string& name)
{
    try {
...
template<class T> inline void ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::accessExisting(const string& name, bool readWriteAccess)
{
    try {
        // If already open, should have called close first.
        CZI_ASSERT(!isOpen);
...
template<class T> inline void ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::accessExistingReadOnly(const string& name)
{
    accessExisting(name, false);
}
template<class T> inline void ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::accessExistingReadWrite(const string& name)
{
...
// Sync the mapped memory to disk.
template<class T> inline void ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::syncToDisk()
{
    CZI_ASSERT(isOpen);
...
// Unmap the memory.
template<class T> inline void ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::unmap()
{
    CZI_ASSERT(isOpen);
...
// Sync the mapped memory to disk, then unmap it.
template<class T> inline void ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::close()
{
    CZI_ASSERT(isOpen);
    syncToDisk();
    unmap();
...
// Return a pointer to the stored object.
template<class T> inline T* ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::operator->()
{
    CZI_ASSERT(isOpen);
    CZI_ASSERT(data);
    return data;
}
template<class T> inline const T* ChanZuckerberg::ExpressionMatrix2::MemoryMapped::Object<T>::operator->() const
{
    CZI_ASSERT(isOpen);
    CZI_ASSERT(data);
    return data;
